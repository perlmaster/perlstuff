...
#
# Purpose   : Extract all files from a ZIP file
#
...
#
# Example   : zipfetch.pl -d arg1 arg2
#
# Notes     : (none)
#
######################################################################
...
zipfetch.pl - Extract all files from a ZIP file

=head1 SYNOPSIS

zipfetch.pl [-hd] zipfile [pattern [... pattern]]
